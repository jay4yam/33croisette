...
@section('content')
    ...
    <section>
        ...
        <div class="flex justify-around w-full p-12">
...
I'm interested in the apartment with reference {{ $property->reference }} in your new “33 Croisette” program in Cannes. Please send me details of this apartment.
    ...
    <!-- cannes infos -->
    <section class="bg-gray-100 mx-auto flex gap-6 my-6">

        <!-- container -->
        <div class="container flex gap-8 items-center justify-end">
            ...
            <div class="w-1/5 text-gray-500 text-justify">
    ...
    <section>
        <div class="container mx-auto flex items-center justify-center gap-12 w-full">
            <img class="w-1/3" loading="lazy" src="{{ asset('images/property/sunshine.webp') }}" alt="sunset in cannes">
    ...
    <section class="py-6">
        <div class="interiors-carousel">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-1.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-2.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-3.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-4.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-5.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-6.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-7.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-8.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-9.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-10.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-11.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-12.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-13.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-14.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-15.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-16.webp') }}" alt="{{ $picture->title }}"></div>
                <div class="swiper-slide"><img loading="lazy" src="{{ asset('images/property/interiors/app-17.webp') }}" alt="{{ $picture->title }}"></div>
    ...
    <section>
        ...
        <div class="mx-auto flex items-center justify-center w-full gap-8 my-6 bg-gray-100">
            <img src="{{ asset('images/bureau_vente.jpg') }}" alt="bureau de vente">

            <div class="w-1/3 flex flex-col text-gray-500 gap-3">
